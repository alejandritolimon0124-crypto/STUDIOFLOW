...
revoke all on function public.studio_flow_artist_get_own_profile(uuid) from public;
revoke all on function public.studio_flow_artist_save_own_profile(uuid, jsonb, boolean) from public;

grant execute on function public.studio_flow_artist_get_own_profile(uuid) to authenticated;
grant execute on function public.studio_flow_artist_save_own_profile(uuid, jsonb, boolean) to authenticated;
