create or replace function public.studio_flow_artist_create_manual_appointment_core(
  p_client_id uuid,
...
revoke all on function public.studio_flow_artist_create_manual_appointment_core(uuid, uuid, date, time, text) from public;
...
revoke all on function public.studio_flow_artist_create_manual_appointment_for_client(uuid, uuid, date, time, text) from public;
grant execute on function public.studio_flow_artist_create_manual_appointment_for_client(uuid, uuid, date, time, text) to authenticated;
