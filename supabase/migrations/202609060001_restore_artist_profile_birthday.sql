...
begin
  ...
  v_birthday := nullif(trim(p_profile ->> 'birthday'), '')::date;
  ...
  insert into artist_profiles (
    artist_id, artistic_name, birthday, bio, specialties, primary_specialty, years_experience,
  ...
  set
    ...
    birthday = coalesce(excluded.birthday, artist_profiles.birthday),
    bio = excluded.bio,
