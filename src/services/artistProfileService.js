...
function mapArtistProfileRow(row = {}) {
  return {
    ...
    studio_photo_paths: row.studio_photo_paths && typeof row.studio_photo_paths === 'object' ? row.studio_photo_paths : {},
...
function profileToPayload(profile = {}, artistId) {
  ...
  return {
    ...
    studio_photo_paths: profile.studioPhotoUrls && typeof profile.studioPhotoUrls === 'object' ? profile.studioPhotoUrls : {},
